...
extern void F77_NAME(fstepwise)(double * y, double * x, int * n, int * k, double * x2, double * res, int * ia, double * alpha, int * kmx, double * pp, int * kex, int * intercept, double * minss, double * ss01, int * qq, int * kmn);
extern void F77_NAME(genint)(double * x, double * xx, int * n, int *k, int * kk, int * kex, int * ord, int * ind, int * ji);
extern void F77_NAME(graphst)(double * xxx, double * x, int * n, int * k, double * y, double * x2, double * res, int * ia, double * alpha, int * kmx, double * pp, int  * grph, int * ne, int * kexc, int * xinr, double * minss, int * nedge, double * ss01, int * kmn, int * lin, int * iind, double * grphp);
extern void F77_NAME(graphstst)(double * xxx, double * x, int * n, int * k, double * y, double * x2, double * res, int * ia, double * alpha, int * kmx, double * pp, int  * grph, int * ne, int * kexc, int * xinr, double * minss, int * nedge, double * ss01, double * rgrph, int * kmn, int * lin, int * iind);
